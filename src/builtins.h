 ...
 */
static const char * const BUILTINS[] = {"echo", "cat", "wc", "cd", "ls", "ps", "kill", "start-server", "close-server", "send", "start-client"};
static const bn_ptr BUILTINS_FN[] = {bn_echo, bn_cat, bn_wc, bn_cd, bn_ls, bn_ps, bn_kill, bn_start_server, bn_close_server, 
    bn_send, bn_start_client, NULL, bn_setvar};
